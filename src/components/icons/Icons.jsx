/**
 * Icon library — pure inline SVG components.
 * All icons use `currentColor` so parent text color cascades.
 */
...
export const ExternalIcon = (props) => (
  <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
...
export const DocumentIcon = (props) => (
  <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" {...props}>
